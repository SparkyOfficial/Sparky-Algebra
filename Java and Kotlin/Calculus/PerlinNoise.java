...
public class PerlinNoise {
    ...
    public static void main(String[] args) {
        System.out.println("perlin noise examples");
        System.out.println("===================");
        
        // simple 2d noise
        System.out.println("simple 2d noise at (0.5, 0.5): " + noise2D(0.5, 0.5));
        System.out.println("simple 2d noise at (1.0, 1.0): " + noise2D(1.0, 1.0));
        System.out.println("simple 2d noise at (2.3, 4.7): " + noise2D(2.3, 4.7));
        
        // octave noise
        System.out.println("\noctave noise at (0.5, 0.5): " + octaveNoise(0.5, 0.5, 4, 0.5));
        System.out.println("octave noise at (1.0, 1.0): " + octaveNoise(1.0, 1.0, 4, 0.5));
        System.out.println("octave noise at (2.3, 4.7): " + octaveNoise(2.3, 4.7, 4, 0.5));
    }
}